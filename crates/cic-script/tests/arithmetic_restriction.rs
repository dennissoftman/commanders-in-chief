...
//! `real::tests::the_polynomial_agrees_with_the_platform_to_the_last_bit_on_the_same_argument` is the
//! comparison that gives this crate's series any credibility. The rule is that an oracle may be
