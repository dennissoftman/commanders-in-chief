...
| [M3](docs/milestones/m3-renderer.md) | Renderer: terrain, models, water, lighting, presentation | Complete — terrain level of detail closed by amendment |
| [M4](docs/milestones/m4-interface.md) | Interface: layout, widgets, shell | In progress — layout and widget behaviour landed |
